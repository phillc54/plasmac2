...
#    if isConvBlock:
        for line in inCode:
            ...
            if line.startswith('#<array_x_offset>'):
                self.coValue.set('{:0.4f}'.format(float(line.split('=')[1].strip())))
            elif line.startswith('#<array_y_offset>'):
                self.roValue.set('{:0.4f}'.format(float(line.split('=')[1].strip())))
                ...
                self.xsValue.set('{:0.4f}'.format(float(line.split('=')[1].strip())))
            elif line.startswith('#<origin_y_offset>'):
                self.ysValue.set('{:0.4f}'.format(float(line.split('=')[1].strip())))
