...
class Conv(tk.Tk):
    def __init__(self, convFirstRun, root, toolFrame, convFrame, imagePath, \
                 tmpPath, pVars, unitsPerMm, comp, prefs, getprefs, putprefs, \
                 fileOpener, wcs_rotation, conv_toggle):
        self.r = root
        ...
        self.ambles = 'G{} G64P{} G40 G49 G80 G90 G92.1 G94 G97'.format(gCode, tolerance)
        self.xOrigin = 0.000
        self.yOrigin = 0.000
...
#       self.convBlockLoaded = self.h.newpin('conv_block_loaded', hal.HAL_BIT, hal.HAL_IN)
    ...
    def shape_request(self, shape): #, material):
        ...
        if self.settingsExited:
            ...
            self.liValue.set('{}'.format(self.leadIn))
            self.loValue.set('{}'.format(self.leadOut))
    ...
    def add_shape_to_file(self):
        ...
        if self.convButton.get() == 'line':
            ...
            self.l1Value.set('{:0.3f}'.format(self.convLine['xLineEnd']))
            self.l2Value.set('{:0.3f}'.format(self.convLine['yLineEnd']))
            self.convLine['addSegment'] = 1
            self.module.line_type_changed(self, True)
            self.addC['state'] = 'disabled'
            self.previewActive = False
        ...
        for child in self.convFrame.winfo_children():
            if not self.settingsExited and isinstance(child, tk.Entry):
                if child.winfo_name() == str(getattr(self, 'liEntry')).rsplit('.',1)[1]:
                    ...
                    self.ocValue.set('{}'.format(4 * self.unitsPerMm))
            child.grid_remove()
        self.show_common_widgets()
    ...
    def show_common_widgets(self):
        ...
        self.previewC.grid(column=0, row=12)
        ...
        self.newC.grid(column=0, row=14)
        self.saveC.grid(column=1, row=14)
        self.settingsC.grid(column=2, row=14)
        self.sendC.grid(column=3, row=14)
    ...
    def create_widgets(self, imagePath):
        ...
        self.matCombo = ttk.Combobox(self.convFrame, width=lLength, justify='right')
        ...
        self.xsEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.xsValue, justify='right')
        self.ysLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('Y ORIGIN'))
        self.ysValue = tk.StringVar()
        self.ysEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.ysValue, justify='right')
        self.liLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('LEAD IN'))
        self.liValue = tk.StringVar()
        self.liEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.liValue, justify='right')
        self.loLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('LEAD OUT'))
        self.loValue = tk.StringVar()
        self.loEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.loValue, justify='right')
        self.polyCombo = ttk.Combobox(self.convFrame, width=lLength, justify='right')
        self.polyCombo.option_add('*TCombobox*Listbox.Justify', 'right')
        self.sLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('SIDES'))
        self.sValue = tk.StringVar()
        self.sEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.sValue, justify='right')
        self.dLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('DIAMETER'))
        self.dValue = tk.StringVar()
        self.dEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.dValue, justify='right')
        self.lLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('LENGTH'))
        self.lValue = tk.StringVar()
        self.lEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.lValue, justify='right')
        self.wLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('WIDTH'))
        self.wValue = tk.StringVar()
        self.wEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.wValue, justify='right')
        ...
        self.aaEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.aaValue, justify='right')
        self.alLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('a LENGTH'))
        self.alValue = tk.StringVar()
        self.alEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.alValue, justify='right')
        self.baLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('B ANGLE'))
        self.baValue = tk.StringVar()
        self.baEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.baValue, justify='right')
        self.blLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('b LENGTH'))
        self.blValue = tk.StringVar()
        self.blEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.blValue, justify='right')
        self.caLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('C ANGLE'))
        self.caValue = tk.StringVar()
        self.caEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.caValue, justify='right')
        self.clLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('c LENGTH'))
        self.clValue = tk.StringVar()
        self.clEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.clValue, justify='right')
        self.hEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.hValue, justify='right')
        self.hdLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('HOLE DIA'))
        self.hdValue = tk.StringVar()
        self.hdEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.hdValue, justify='right')
        self.hoLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('# HOLES'))
        self.hoValue = tk.StringVar()
        self.hoEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.hoValue, justify='right')
        self.bcaLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('CIRCLE ANG'))
        self.bcaValue = tk.StringVar()
        self.bcaEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.bcaValue, justify='right')
        self.ocLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('OVERCUT'))
        self.ocValue = tk.StringVar()
        self.ocEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.ocValue, justify='right')
        ...
        self.pEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.pValue, justify='right')
        self.odLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('OUTER DIA'))
        self.odValue = tk.StringVar()
        self.odEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.odValue, justify='right')
        self.idLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('INNER DIA'))
        self.idValue = tk.StringVar()
        self.idEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.idValue, justify='right')
        ...
        self.rEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.rValue, justify='right')

        self.saLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('SEC ANGLE'))
        self.saValue = tk.StringVar()
        self.saEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.saValue, justify='right')

        self.aLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('ANGLE'))
        self.aValue = tk.StringVar()
        self.aEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.aValue, justify='right')
        ...
        self.r1Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.r1Value, justify='right')
        ...
        self.r2Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.r2Value, justify='right')
        ...
        self.r3Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.r3Value, justify='right')
        ...
        self.r4Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.r4Value, justify='right')
        ...
        self.cnEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.cnValue, justify='right')
        self.coLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('OFFSET'))
        self.coValue = tk.StringVar()
        self.coEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.coValue, justify='right')
        ...
        self.rnEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.rnValue, justify='right')
        self.roLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('OFFSET'))
        self.roValue = tk.StringVar()
        self.roEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.roValue, justify='right')
        ...
        self.scEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.scValue, justify='right')
        self.rtLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('ROTATION'))
        self.rtValue = tk.StringVar()
        self.rtEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.rtValue, justify='right')
        ...
        self.lineCombo = ttk.Combobox(self.convFrame, width=lLength, justify='right')
        self.lineCombo.option_add('*TCombobox*Listbox.Justify', 'right')
        self.l1Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l1Value = tk.StringVar()
        self.l1Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l1Value, justify='right')
        self.l2Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l2Value = tk.StringVar()
        self.l2Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l2Value, justify='right')
        self.l3Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l3Value = tk.StringVar()
        self.l3Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l3Value, justify='right')
        self.l4Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l4Value = tk.StringVar()
        self.l4Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l4Value, justify='right')
        self.l5Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l5Value = tk.StringVar()
        self.l5Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l5Value, justify='right')
        self.l6Label = tk.Label(self.convFrame, width=lLength, anchor='e', text='')
        self.l6Value = tk.StringVar()
        self.l6Entry = tk.Entry(self.convFrame, width=eLength, textvariable=self.l6Value, justify='right')
        ...
        self.preEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.preValue)
        self.pstLabel = tk.Label(self.convFrame, width=lLength, anchor='e', text=_('POSTAMBLE'))
        self.pstValue = tk.StringVar()
        self.pstEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.pstValue)
        ...
        self.shEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.shValue, justify='right')
        self.hsValue = tk.StringVar()
        self.hsEntry = tk.Entry(self.convFrame, width=eLength, textvariable=self.hsValue, justify='right')
